        ...
        <div className="rounded-[16px] border-2 border-primary/30 bg-linear-white p-6 backdrop-blur-[35px] md:p-8">
          <div className="prose prose-invert max-w-none">
            ...
            <p className="mb-4 text-sm leading-relaxed text-slate-800/90 md:text-base">
              The website https://invarifi.com and other related pages (the "Website") are
              operated by InvariFi (the "Platform", "we" or "us"). InvariFi is a
            ...
            <p className="mb-6 text-sm leading-relaxed text-slate-800/90 md:text-base">
              Your privacy is very important for InvariFi. This is the Cookie Policy of InvariFi's 
              Website which provides detailed information about how and when we use cookies.
              All personal information obtained by InvariFi on or through its Website is
            ...
            <section className="mb-8">
              ...
              <p className="mb-4 text-sm leading-relaxed text-slate-800/90 md:text-base">
                Upon entering the InvariFi Website your device may automatically be issued with
                ...
                the date, time and duration of your visit. InvariFi will only use cookies for
            ...
            <section className="mb-8">
              <h2 className="mb-4 text-xl font-semibold text-slate-800 md:text-2xl">Contact us</h2>
              <p className="mb-4 text-sm leading-relaxed text-slate-800/90 md:text-base">
                If you have any questions or comments about this Cookie Policy or if you would like
                us to update information we have about you, please email: support@invarifi.com.
              </p>
            </section>
          </div>
        </div>
