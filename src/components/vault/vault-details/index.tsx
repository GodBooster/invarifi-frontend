...
import { getVaultDetailsTabs } from './getVaultDetailsTabs';
...
export const VaultDetails = ({ vault }: VaultDetailsProps) => {
  const valultDetailTabs = useMemo(() => getVaultDetailsTabs(vault), [vault]);
